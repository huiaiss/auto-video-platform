...
# Check 5: clip diversity - count source clip files
    clip_dir = os.path.dirname(VIDEO)
    clip_files = [f for f in os.listdir(clip_dir) if f.startswith("_clip_") and f.endswith(".mp4")]
